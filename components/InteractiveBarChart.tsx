// components/InteractiveBarChart.tsx
  ...
  return (
    <Card className="bg-white dark:bg-gray-800 max-w-full max-h-[400px] overflow-hidden">
          ...
          {["desktop", "mobile"].map((key) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-lg font-bold leading-none sm:text-3xl text-black dark:text-white">
      ...
      <CardContent className="px-2 sm:p-6">
        <ChartContainer
          config={chartConfig}
          className="aspect-auto h-[0px] w-full"
        >
          <BarChart
            accessibilityLayer
            data={chartData}
          ...
          >
            <CartesianGrid vertical={false} strokeDasharray="3 3" stroke="var(--color-grid)" />
            <XAxis
              dataKey="date"
              tickLine={false}
              axisLine={false}
